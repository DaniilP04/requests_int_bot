...
main = ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text='Оставить заявку')],
                                     [KeyboardButton(text="Мои заявки")],
                                     [KeyboardButton(text="Помощь")]
                                     ],resize_keyboard=True,one_time_keyboard=True, input_field_placeholder="Выберите пункт в меню...")
...
device_kb = ReplyKeyboardMarkup(
    keyboard=[
        ...
        [KeyboardButton(text='Браслет')],
        [KeyboardButton(text='Брелок')]
    ],
    resize_keyboard=True
)
no_patronymic_kb = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text='Нет отчества')]
    ],
    resize_keyboard=True,
...
back_kb = ReplyKeyboardMarkup(keyboard=[[KeyboardButton(text="Назад")]],
...
bracelet_colors_kb = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text="Бирюзовый"),KeyboardButton(text="Красный")],
        [KeyboardButton(text="Чёрный"),KeyboardButton(text="Жёлтый")],
        [KeyboardButton(text="Синий"),KeyboardButton(text="Зелёный")]
    ],
    resize_keyboard=True
)
